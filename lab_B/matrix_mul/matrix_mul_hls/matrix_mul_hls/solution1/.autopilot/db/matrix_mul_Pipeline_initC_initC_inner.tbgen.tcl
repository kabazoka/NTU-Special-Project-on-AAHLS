...
set C_modelArgList {
	{ N int 32 regular  }
	{ mul_ln53 int 63 regular  }
	{ local_C float 32 regular {array 65536 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "N", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln53", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln53 sc_in sc_lv 63 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln53", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "mul_ln53", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mul_ln53 { ap_none {  { mul_ln53 in_data 0 63 } } }

...
HLS_SOURCES = ../../../../src/testbench.cpp ../../../../src/matrix_mul.cpp
...
$(ObjDir)/matrix_mul.o: ../../../../src/matrix_mul.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/matrix_mul.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)

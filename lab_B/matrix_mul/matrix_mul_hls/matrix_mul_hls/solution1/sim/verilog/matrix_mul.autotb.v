...
`define AUTOTB_DUT      matrix_mul
`define AUTOTB_DUT_INST AESL_inst_matrix_mul
`define AUTOTB_TOP      apatb_matrix_mul_top
`define AUTOTB_LAT_RESULT_FILE "matrix_mul.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matrix_mul.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matrix_mul_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_gmem1.dat"
`define AUTOTB_TVIN_A_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_B.dat"
`define AUTOTB_TVIN_C_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_C.dat"
`define AUTOTB_TVIN_M_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_M.dat"
`define AUTOTB_TVIN_N_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_N.dat"
`define AUTOTB_TVIN_K_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvin_K.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.matrix_mul.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.matrix_mul.autotvout_gmem2.dat"
module `AUTOTB_TOP;

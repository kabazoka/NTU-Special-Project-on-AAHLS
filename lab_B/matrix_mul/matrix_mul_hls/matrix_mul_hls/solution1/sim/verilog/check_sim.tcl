...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrix_mul.autotvin_gmem0.dat"
         "c.matrix_mul.autotvin_gmem1.dat"
         "c.matrix_mul.autotvin_A.dat"
         "c.matrix_mul.autotvin_B.dat"
         "c.matrix_mul.autotvin_C.dat"
         "c.matrix_mul.autotvin_M.dat"
         "c.matrix_mul.autotvin_N.dat"
         "c.matrix_mul.autotvin_K.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrix_mul.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

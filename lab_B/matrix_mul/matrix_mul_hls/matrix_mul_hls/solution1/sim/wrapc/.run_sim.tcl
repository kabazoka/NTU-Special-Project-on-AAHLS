...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrix_mul.autotvin.dat"
	set constFileTvOut       "matrix_mul.autotvout.dat"
	set constFileHdlTvIn     "matrix_mul.autohdltvin.dat"
	set constFileHdlTvOut    "matrix_mul.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

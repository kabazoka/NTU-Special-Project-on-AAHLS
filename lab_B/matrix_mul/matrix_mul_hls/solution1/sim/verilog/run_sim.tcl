...
if {[file isfile matrix_mul.autotvin.dat]} {
	file delete -force matrix_mul.autotvin.dat
}

if {[file isfile matrix_mul.autotvout.dat]} {
	file delete -force matrix_mul.autotvout.dat
}

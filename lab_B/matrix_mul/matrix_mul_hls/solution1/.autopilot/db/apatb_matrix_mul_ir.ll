; ModuleID = '/home/ubuntu/Documents/GitHub/NTU-Special-Project-on-AAHLS/lab_B/matrix_mul/matrix_mul_hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_matrix_mul_hw(float* %A_copy, float* %B_copy, float* %C_copy, i32 %M, i32 %N, i32 %P)
...
entry:
  ...
  call void @matrix_mul_hw_stub(float* %0, float* %1, float* %2, i32 %3, i32 %4, i32 %5)
